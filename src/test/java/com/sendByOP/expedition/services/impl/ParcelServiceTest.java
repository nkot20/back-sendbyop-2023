...
public class ParcelServiceTest {
    ...
    @Test
    void findAllParcelsByBooking_ShouldReturnListOfParcels() throws SendByOpException {
        // Arrange
        List<Parcel> parcels = Arrays.asList(parcel);
        when(bookingMapper.toEntity(any(BookingDto.class))).thenReturn(booking);
        when(parcelRepository.findByReservation(any(Booking.class))).thenReturn(parcels);
        ...
        verify(parcelRepository, times(1)).findByReservation(any(Booking.class));
    }
}