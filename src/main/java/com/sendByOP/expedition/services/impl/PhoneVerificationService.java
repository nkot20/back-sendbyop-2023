...
import com.sendByOP.expedition.services.iServices.IPhoneVerificationService;
...
public class PhoneVerificationService implements IPhoneVerificationService {
    ...
    @Override
    public VerificationResult checkVerification(String phone, String code) throws SendByOpException {
